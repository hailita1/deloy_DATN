...
import {UtilitiesItemComponent} from '../../host/utilities/utilities-item/utilities-item.component';
...
@Component({
  ...
  styleUrls: ['./list-utilities.component.scss']
})
export class ListUtilitiesComponent implements OnInit {
  // @ts-ignore
  @ViewChild(ItemUtilitiesComponent) view!: ItemUtilitiesComponent;
