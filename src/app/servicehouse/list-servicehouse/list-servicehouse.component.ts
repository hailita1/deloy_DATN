...
import {ServiceItemComponent} from '../../host/service/service-item/service-item.component';
...
@Component({
  ...
  templateUrl: './list-servicehouse.component.html',
  styleUrls: ['./list-servicehouse.component.scss']
})
export class ListServicehouseComponent implements OnInit {
  // @ts-ignore
  @ViewChild(ItemservicehouseComponent) view!: ItemservicehouseComponent;
  listService: Service[];
